...
import DateNavHeader from "../../components/moodComponents/DateNavHeader/DateNavHeader";
import MoodsList from "../../components/moodComponents/MoodList/MoodList.js";
  ...
  render() {
    ...
    return (
      <ScrollView style={{ flex: 1 }}>
        ...
        />
        <Button title="Generate" color="#e76f51" onPress={() => this.reseedDatabase()} />
      </ScrollView>
    );
  }
}
